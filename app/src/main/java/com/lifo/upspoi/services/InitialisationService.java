...
public class InitialisationService {
    ...
    private void initialiserBaseMarqueur() {
        ...
        List<ElementDeCarte> elementsRecyclagePaulSabatier = Lists.newArrayList(
                ...
                new ElementDeCarte("pile", Lists.newArrayList(listeTag.get("recyclage"), listeTag.get("piles")), new Image("", null), Lists.newArrayList(new LatLng(43.56362, 1.46487), new LatLng(43.56381, 1.46537), new LatLng(43.56354, 1.4657), new LatLng(43.5633, 1.46522))),
                new ElementDeCarte("pile", Lists.newArrayList(listeTag.get("recyclage"), listeTag.get("piles")), new Image("", null), Lists.newArrayList(new LatLng(43.56456, 1.46589), new LatLng(43.56472, 1.46617), new LatLng(43.56458, 1.46629), new LatLng(43.56446, 1.46602))),
